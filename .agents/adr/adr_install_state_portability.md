...
**Research artifact:** [`research_state_portability_v2.md`](../research/research_state_portability_v2.md)
(round-2 multi-agent research: devcontainer-id, layout conventions, shared-home
semantics, codebase blast radius). Round-1: [`research_state_portability.md`](../research/research_state_portability.md).
