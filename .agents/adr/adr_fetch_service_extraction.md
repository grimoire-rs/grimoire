...
[design_fetch_service_extraction.md](../specs/design_fetch_service_extraction.md)
(implementation spec).
...
- [design_fetch_service_extraction.md](../specs/design_fetch_service_extraction.md) — implementation spec, file-by-file
