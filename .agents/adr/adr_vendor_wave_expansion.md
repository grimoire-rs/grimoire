...
**Research artifact:** [`research_spec_kit_rendering.md`](../research/research_spec_kit_rendering.md) + session recon (client landscape, rule-scoping survey, 2026-07-19).
