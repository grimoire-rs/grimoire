...
| Label | Scope |
|-------|-------|
| `area/registry` | OCI registry interaction, install/publish |
| `area/file-structure` | Storage, content-addressed layout |
...
- **Title**: Conventional Commit format matching primary commit (e.g., `feat: add install command`). PR titles keep `type:` prefix; issue titles don't.
