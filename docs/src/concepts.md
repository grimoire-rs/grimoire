...
arms only behind an explicit feature flag and this workspace's own consent,
and reports the gate that is still closed until both are given. See
...
A **bundle** is a curated set of members — skills, rules, agents, hooks, and
[MCP servers](./mcp-servers.md). You
